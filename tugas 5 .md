...
Produsen mencoba memasukkan data ke slot kosong buffer. Seorang konsumen mencoba untuk menghapus data dari slot diisi dalam buffer. Seperti yang mungkin sudah Anda duga sekarang, kedua proses tersebut tidak akan menghasilkan output yang diharapkan jika dijalankan secara bersamaan. Perlu ada cara untuk membuat produsen dan konsumen bekerja secara independen.
